	...
	return (
		<div className="max-w-md mx-auto px-4 py-24 text-center">
			...
			<button
				...
				className="w-full h-10 px-4 text-sm font-medium border border-[var(--border)] bg-[var(--background)] hover:bg-[var(--secondary)] transition-colors inline-flex items-center justify-center gap-2 rounded"
			>
